          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-3 md:gap-6">
              <div className="flex items-center gap-2">
                <Phone className={`w-4 h-4 ${isTransparent ? "text-white" : "text-gray-600"}`} />
                <span className={`hidden sm:inline ${isTransparent ? "text-white" : "text-gray-600"}`}>
                  +92 42 111 789 456
                </span>
                <span className={`sm:hidden ${isTransparent ? "text-white" : "text-gray-600"}`}>Call Us</span>
              </div>
              <div className="flex items-center gap-2">
                <MessageCircle className={`w-4 h-4 ${isTransparent ? "text-green-400" : "text-green-600"}`} />
                <span className={`hidden sm:inline ${isTransparent ? "text-white" : "text-gray-600"}`}>
                  +92-345-4037778
                </span>
                <span className={`sm:hidden ${isTransparent ? "text-white" : "text-gray-600"}`}>WhatsApp</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`hidden sm:inline ${isTransparent ? "text-white" : "text-gray-600"}`}>My Account</span>
              <span className={`sm:hidden ${isTransparent ? "text-white" : "text-gray-600"}`}>Account</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <button className="hidden md:flex items-center gap-2 hover:opacity-80 transition-opacity">
              <Search className={`w-5 h-5 ${isTransparent ? "text-white" : "text-gray-900"}`} />
